...
export default () => (
  <div>
    <DevelopmentLogo />
    <Promo />
    <Card img={`${process.env.PUBLIC_URL}/img/complex-1.png`} district="SOUTH BEACH, SAN FRANCISCO" address="764 Metropolitan Avenue">
    ...
    <Card img={`${process.env.PUBLIC_URL}/img/complex-2.jpg`} district="MIDTOWN EAST, MANHATTAN" address="100 East 53rd Street">
    ...
    <Card img={`${process.env.PUBLIC_URL}/img/complex-3.jpg`} district="NOLITA, MANHATTAN" address="152 Elizabeth">
