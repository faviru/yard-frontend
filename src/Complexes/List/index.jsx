  ...
  <div>
    ...
    <Card img={`${process.env.PUBLIC_URL}/img/complex-2.jpg`} district="MIDTOWN EAST, MANHATTAN" name="100 East 53rd Street">
      One Hundred East Fifty Third Street by Foster + Partners is a limited collection of
       modern residences in Midtown Manhattan&apos;s Cultural District. The 94 residences
        ranging from alcove lofts to four bedrooms within the 63-story tower are generously
         proportioned.
    </Card>
